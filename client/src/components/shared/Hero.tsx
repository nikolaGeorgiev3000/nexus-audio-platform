export default function Hero() {
    return (
        <header className="relative pt-32 pb-20 px-6 text-center overflow-hidden bg-white dark:bg-slate-900 transition-colors">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <h1 className="text-6xl md:text-8xl font-bold tracking-tighter text-slate-900 dark:text-white mb-8">
                    Sonic <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-blue-400 dark:to-cyan-300">Architecture</span>
                </h1>
